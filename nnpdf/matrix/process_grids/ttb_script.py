...
mttb = ["--set-key-value", "x1_label", "top pair mass", 
        "--set-key-value", "x1_label_tex", '$m_{t\bar{t}}$',
        "--set-key-value", "x1_unit", "GeV",
        "--set-key-value", "y_label", "differential x-sec",
        "--set-key-value", "y_label_tex", '$\frac{d\sigma}{dm_{t\bar{t}}}$',
        "--set-key-value", "y_unit", "pb/GeV"]

ptt = ["--set-key-value", "x1_label", "top transverse momentum", 
       "--set-key-value", "x1_label_tex", '$pT_t$',
       "--set-key-value", "x1_unit", "GeV",
       "--set-key-value", "y_label", "differential x-sec",
       "--set-key-value", "y_label_tex", '$\frac{d\sigma}{dpT_t}$',
       "--set-key-value", "y_unit", "pb/GeV"]

absyt = ["--set-key-value", "x1_label", "top abs rapidity",
         "--set-key-value", "x1_label_tex", '$|y_t|$',
         "--set-key-value", "x1_unit", "",
         "--set-key-value", "y_label", "differential x-sec",
         "--set-key-value", "y_label_tex", '$\frac{d\sigma}{d|y_t|}$',
         "--set-key-value", "y_unit", "pb"]

yt = ["--set-key-value", "x1_label", "top rapidity",
      "--set-key-value", "x1_label_tex", '$y_t$',
      "--set-key-value", "x1_unit", "",
      "--set-key-value", "y_label", "differential x-sec",
      "--set-key-value", "y_label_tex", '$\frac{d\sigma}{dy_t}$',
      "--set-key-value", "y_unit", "pb"]

absyttbar = ["--set-key-value", "x1_label", "top pair abs rapidity",
             "--set-key-value", "x1_label_tex", '$|y_{t\bar{t}}|$',
             "--set-key-value", "x1_unit", "",
             "--set-key-value", "y_label", "differential x-sec",
             "--set-key-value", "y_label_tex", '$\frac{d\sigma}{d|y_{t\bar{t}}|}$',
             "--set-key-value", "y_unit", "pb"]

yttbar = ["--set-key-value", "x1_label", "top pair rapidity",
          "--set-key-value", "x1_label_tex", '$y_{t\bar{t}}$',
          "--set-key-value", "x1_unit", "",
          "--set-key-value", "y_label", "differential x-sec",
          "--set-key-value", "y_label_tex", '$\frac{d\sigma}{dy_{t\bar{t}}}$',
          "--set-key-value", "y_unit", "pb"]
...
def process_8():
    ...
    if os.path.exists(input_path): subprocess.run(default + mttb + [input_path, output_path])
    else: gnf8.append(input_path)
    ...
    if os.path.exists(input_path): subprocess.run(default + absyttbar + [input_path, output_path])
    else: gnf8.append(input_path)
    ...
    if os.path.exists(input_path): subprocess.run(default + absyt + [input_path, output_path])
    else: gnf8.append(input_path)
    ...
    if os.path.exists(input_path): subprocess.run(default + ptt + [input_path, output_path])
    else: gnf8.append(input_path)
    ...
    # intermediate_path = output + "/CMS_TTBAR_8TEV_LJ_DIF_YTTBAR_intermediate" + new_suffix
    # output_path = output + "/CMS_TTBAR_8TEV_LJ_DIF_YTTBAR" + new_suffix
    # if os.path.exists(input_path): 
    #     subprocess.run(["python", './matrix_yttbar.py', '-g', input_path, '-o', intermediate_path])
    ...
    if os.path.exists(input_path): subprocess.run(default + yt + [input_path, output_path])
    else: gnf8.append(input_path)
    ...
    if os.path.exists(input_path): subprocess.run(default + 
                   ["--set-key-value", "x1_label", "top abs rapidity",
         "--set-key-value", "x1_label_tex", '$|y_t|$',
         "--set-key-value", "x1_unit", ""] + 
         ["--set-key-value", "x2_label", "top transverse momentum", 
       "--set-key-value", "x2_label_tex", '$pT_t$',
       "--set-key-value", "x2_unit", "GeV"] +
       ["--set-key-value", "y_label", "double diff x-sec",
      "--set-key-value", "y_label_tex", '$\frac{d^2\sigma}{d|y_t|dpT_t}$',
      "--set-key-value", "y_unit", "pb/GeV"] + 
    ...
    if os.path.exists(input_path): subprocess.run(default + 
                   ["--set-key-value", "x1_label", "top pair mass",
         "--set-key-value", "x1_label_tex", '$m_{t\bar{t}}$',
         "--set-key-value", "x1_unit", "GeV"] + 
         ["--set-key-value", "x2_label", "top abs rapidity",
       "--set-key-value", "x2_label_tex", '$|y_t|$',
         "--set-key-value", "x2_unit", ""] +
         ["--set-key-value", "y_label", "double diff x-sec",
        "--set-key-value", "y_label_tex", '$\frac{d^2\sigma}{dm_{t\bar{t}}d|y_t|}$',
        "--set-key-value", "y_unit", "pb/GeV"] + 
                   [input_path, output_path])
    else: gnf8.append(input_path)
    ...
    if os.path.exists(input_path): subprocess.run(default + 
         ...
         "--set-key-value", "x1_label_tex", '$m_{t\bar{t}}$',
         "--set-key-value", "x1_unit", "GeV"] + 
         ["--set-key-value", "x2_label", "top pair abs rapidity",
       "--set-key-value", "x2_label_tex", '$|y_{t\bar{t}}|$',
         "--set-key-value", "x2_unit", ""] +
         ["--set-key-value", "y_label", "double diff x-sec",
        "--set-key-value", "y_label_tex", '$\frac{d^2\sigma}{dm_{t\bar{t}}d|y_{t\bar{t}}|}$',
        "--set-key-value", "y_unit", "pb"] + 
                   [input_path, output_path])
    else: gnf8.append(input_path)
