{
  if (sd == 1){
    ...
    double mt = 172.5 ; //PARTICLE("top")[0].m;
    double ptt2  = PARTICLE("top")[0].pT2;
    double pttx2 = PARTICLE("atop")[0].pT2;
    temp_mu_central = sqrt(pow(mt, 2) + ptt2)/4 + sqrt(pow(mt, 2) + pttx2)/4;
  }
  else if (sd == 3){
